...
export interface Movie {
    ...
    vote_average: number;
    vote_count: number;
    // Extended properties often included in our app via append_to_response
...
export type MovieResult = MovieListResponse;
...
export interface DailyMovie extends Movie {
    source?: string;
