...
import { MovieListResponse, Movie, Video, Credits, ImageResponse } from '../types/tmdb';
...
export const getCuratedMovies = async (page: number = 1): Promise<MovieListResponse> => {
    try {
        ...
        /** @type {import('../types/tmdb').MovieListResponse} */
...
// "The 50% Niche"
export const getHiddenGems = async (page: number = 1): Promise<MovieListResponse> => {
    try {
        const response = await tmdb.get('/discover/movie', {
            params: {
                page,
        ...
        return { results: [], total_pages: 0, total_results: 0, page: 0 };
    }
};

export const getMovieDetails = async (id: number | string): Promise<Movie | null> => {
...
export const getPersonDetails = async (id: number | string): Promise<any | null> => {
    try {
...
export const getCompanyDetails = async (id: number | string): Promise<any | null> => {
    try {
...
export const discoverMovies = async (params: any = {}): Promise<MovieListResponse> => {
    try {
        const response = await tmdb.get('/discover/movie', {
            params: {
                include_adult: false,
...
const fetchCategory = async (endpoint: string, page: number = 1): Promise<MovieListResponse> => {
    try {
...
export const getNowPlayingMovies = (page: number = 1) => fetchCategory('/movie/now_playing', page);
export const getUpcomingMovies = (page: number = 1) => fetchCategory('/movie/upcoming', page);
export const getTopRatedMovies = (page: number = 1) => fetchCategory('/movie/top_rated', page);
export const getCompanyMovies = async (companyId: number | string, page: number = 1): Promise<MovieListResponse> => {
    try {
        const response = await tmdb.get('/discover/movie', {
            params: {
